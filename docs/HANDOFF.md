...
## Goal
- Derive the actual deliverable from `/Users/hsh/datasc/pdf/IC_PBL시나리오.pdf`.
...
## Next
1. Read `IC_PBL시나리오.pdf`.
2. Extract deliverable requirements.
3. Map requirements to FAF data and chapter PDFs.

## Open
- Exact deliverable format from `IC_PBL시나리오.pdf` is still not extracted.
